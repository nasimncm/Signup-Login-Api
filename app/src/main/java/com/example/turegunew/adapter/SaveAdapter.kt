...
class SaveAdapter(
    val context: Context, val saveList: List<Favourite>
) : RecyclerView.Adapter<SaveAdapter.SearchViewHolder>() {
...
/*        holder.itemView.setOnClickListener {
    ...
    class SearchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun searchBind(model: Favourite, position: Int) {
//            tvName.text = model.name[position].text.toString()
        ...
        fun setBannerSlider(list: List<FavPhoto>, context: Context) {
            var adapterBannerSlider = SaveImageAdapter(context, list)
